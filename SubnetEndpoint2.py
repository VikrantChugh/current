...
def insert_storage_volume_into_db(storage_list):
    ...
    try:
        ...
        table_name = 'cmdb_ci_endpoint_subnet55'
        ...
        create_table = """
        CREATE TABLE IF NOT EXISTS cmdb_ci_endpoint_subnet55 (
        ...
        for iteam in storage_list:
            insert_query = """
                INSERT INTO cmdb_ci_endpoint_subnet55(Account_ID,Subnet_Object_ID,VM_Object_ID,Data_Center,Vnic_attachment_id) 
                values(%s,%s,%s,%s,%s);
            """
