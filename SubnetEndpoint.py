...
def get_all_vm_names(compartment_id):
    try:
...
def insert_storage_volume_into_db(storage_list):
    ...
    try:
        ...
        for iteam in storage_list:
            insert_query = """
                INSERT INTO cmdb_ci_endpoint_subnet(Account_ID,Subnet_Object_ID,VM_Object_ID,Data_Center) 
                values(%s,%s,%s,%s);
            """
...
get_all_vm_names(compartment_ocid)
