                ...
                try:
                    for regions in region_list:
                        ...
                        for instance in list_instances_response.data:
                            ...
                            list_subnets = compute_client.list_vnic_attachments(compartment.id,instance_id=instance.id)  
                            print(list_subnets.data)
                            for list_subnet in list_subnets.data:                         
                                # print(list_subnet.id)
                            # Append VM details to vm_list
                                vm_list.append({
                                    ...
                                    'Subnet':             list_subnet.data.__dict__.get('_subnet_id',' '),
                                    'Tags':               str(instance_response.get('_defined_tags',' ').get('Oracle-Tags',' ')),
                                    'Vnic_attachment_id': list_subnet.id
